...
#Was having an issue with the svg showing up blank
import matplotlib
matplotlib.use('SVG')

df = pd.read_csv(r'D:\WebScraper\Restaurant_Data_Scraped.csv')
# print(df.columns) I was having an issue so I needed to see how it was reading the columns of my CSV file
...
#Sets the color of the bar to its rating
